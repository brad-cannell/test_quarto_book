...
If I don't want `@sec-images` to automatically be replaced with `Chapter 7` -- for example, I want it to say `the images chapter` instead -- then we can use the following alternative syntax:
...
````markdown
See [the images chapter @sec-images]
````

Which looks like this: See [the images chapter @sec-images]
...
### Reference a chapter section

Chapter sections work the same way. You are able to cross-reference any heading at any level. In the following example, we want to cross-reference the "Adding figures with Knitr" section of the "Images" chapter.   

````markdown
## Adding figures with Knitr {#sec-adding-figures-with-knitr}
...
````markdown
See @sec-adding-figures-with-knitr to learn about images.
````

Which looks like this: See @sec-adding-figures-with-knitr to learn about images.

Alternatively, we can once again use hyperlink syntax:

#### Alternative syntax 1

````markdown
See [the knitr section of the images chapter](../images/images.qmd#adding-figures-with-knitr)
````

Which looks like this: See [the knitr section of the images chapter](../images/images.qmd#adding-figures-with-knitr)

::: callout-important
## Hyperlink file paths
The syntax above isn't working for section headings as of this writing. It links to the images page, but not the knitr section of the page.
:::

#### Alternative syntax 2

````markdown
See [the knitr section of the images chapter @sec-adding-figures-with-knitr]
````

Which looks like this: See [the knitr section of the images chapter @sec-adding-figures-with-knitr]
