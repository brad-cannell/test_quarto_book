...
This video by Melissa Van Bussel gives a nice, brief overview on how to use GitHub Actions to make publishing with GitHub pages even easier by removing the need to render files locally before pushing to GitHub.

{{< video https://youtu.be/arzBRW5XIkg?si=RgHVRxIh_KGxEdJZ >}}
